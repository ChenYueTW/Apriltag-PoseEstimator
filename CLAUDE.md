...
- `camera.py` is **independent legacy code** — the web app does not use it and adjusting settings in the UI does not affect it (and vice versa). Only one process can hold the camera at a time.
